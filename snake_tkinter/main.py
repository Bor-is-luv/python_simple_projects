...
def main():
    ...
    if IN_GAME:
        ...
        c.create_text(WIDTH / 2, HEIGHT / 2, text="COMPUTER TRAINING CENTER!", font="Arial 18", fill="red")
...
c = Canvas(root, width=WIDTH, height=HEIGHT, bg="#4169E1")
c.grid()
c.focus_set()
